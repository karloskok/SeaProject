...
public class MainMenuManager : MonoBehaviour {
	...
	void CreateAllShips(){
		...
		shipyardShips.Add(new Ship("Cutter Pirate", 1, 5, 10, 350, 10, 10));
		shipyardShips.Add(new Ship("Cutter Royal", 2, 6, 11, 420, 10, 10));
		shipyardShips.Add(new Ship("Brig royal", 3, 8, 10, 500, 10, 10));
		shipyardShips.Add(new Ship("Brig royal", 4, 10, 12, 700, 10, 10));
		shipyardShips.Add(new Ship("Brig pirate", 5, 11, 15, 745, 10, 10));

		shipyardShips.Add(new Ship("Brig royal", 6, 13, 10, 880, 10, 10));
		shipyardShips.Add(new Ship("Line ship pirate", 7, 10, 14, 1000, 10, 10));
		shipyardShips.Add(new Ship("Line ship pirate", 8, 9, 15, 1300, 10, 10));
		shipyardShips.Add(new Ship("line ship royal", 9, 15, 17, 1500, 10, 10));
